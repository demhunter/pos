...
**/
package com.pos.basic.sm.states;
...
import com.pos.basic.sm.common.CustomXMLReader;
...
public class FSMStates implements java.io.Serializable {
    ...
    private ArrayList _states;// 状态列表
     ...
     * 设置当前状态值
     *
     * @param curStat 当前状态String
     */
    public void setCurrentState(String curStat) {
        for (Object fsmStateObj : this._fsmStates) {
            FSMState fsmState = (FSMState) fsmStateObj;
            if (fsmState.getCurrentState().equals(curStat)) {
                this._curState = fsmState;
                return;
            }
        }

        throw new IllegalStateException("非法的当前状态值！");
    }
