...
**/
package com.pos.basic.sm.action;
...
public abstract class FSMAction {
     ...
     * 执行动作
     *
     * @param fromState 迁移前的状态
     * @param toState 迁移后的状态
     * @param context 传入数据（上下文）
     * @return 处理结果
     */
    public abstract boolean action(String fromState, String toState, Object context);
     ...
     * happens.
     */
    public void afterTransition(String fromState, String toState, Object context) {
        /*
     ...
     * happens.
     */
    public void entry(String fromState, String toState, Object context) {
        /*
         * Can be used by the calling function before transition has taken place
         */
    }
     ...
     * happens.
     */
    public void exit(String fromState, String toState, Object context) {
        /*
         * Can be used by the calling function after transition has taken place
         */
    }
