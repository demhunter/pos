...
public class OrderCreateDto {
    ...
    private String P7_idCardType; // 证件类型，[IDCARD：身份证]

    private String P8_idCardNo; // 证件号码[身份证号码]

    private String P9_cardNo; // 银行卡号

    private String P10_year; // 信用卡有效期年份[当银行卡是信用卡时必输]

    private String P11_month; // 信用卡有效期月份[当银行卡是信用卡时必输]

    private String P12_cvv2;  // cvv2[当银行卡是信用卡时必输]

    private String P13_phone;  // 手机号码

    private String P14_currency; // 交易币种，[CNY，暂只支持人民币]

    private String P15_orderAmount; // 交易金额，[以元为单位，最小金额为0.01，PS:但实际测试为0.11]

    private String P16_goodsName; // 商品名称

    private String P17_goodsDesc; // 商品描述

    private String P18_terminalType; // 终端类型，[IMEI、MAC、UUID（针对 IOS 系统）、OTHER]

    private String P19_terminalId; // 终端标识，[终端唯一标识，如手机序列号]

    private String P20_orderIp; // 下单ip，[用户支付时使用的网络终端IP]

    private String P21_period; // 订单有效时间，[过了订单有效时间的订单会被设置为取消状态不能再重新进行支付]

    private String P22_periodUnit; // 有效时间单位，[Day：天；Hour：时；Minute：分]
