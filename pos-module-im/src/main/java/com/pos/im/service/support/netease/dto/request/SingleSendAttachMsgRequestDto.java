 ...
 */
public class SingleSendAttachMsgRequestDto {
    private String from;//必须 发送者accid，用户帐号，最大32字符，APP内唯一
    private int msgtype;//必须 0：点对点自定义通知，1：群消息自定义通知，其他返回414
    private String to;//必须 	msgtype==0是表示accid即用户id，msgtype==1表示tid即群id
