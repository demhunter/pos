...
import com.pos.web.customer.converter.PosConverter;
...
@RestController
@RequestMapping("/pos")
@Api(value = "/pos", description = "v1.0.0 * POS业务相关接口")
...
//            List<PosBankCard> inCards = posService.queryUserCards(userId, CardUsageEnum.IN_CARD.getCode());
//            List<PosBankCard> outCards = posService.queryUserCards(userId, CardUsageEnum.OUT_CARD.getCode());
...
//    }
    ...
    public ApiResult<GetSignDto> getSign(
        ...
        GetSignDto result = new GetSignDto();
