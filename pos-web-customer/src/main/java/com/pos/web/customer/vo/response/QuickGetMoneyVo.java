...
public class QuickGetMoneyVo implements Serializable {
    ...
    public QuickGetMoneyVo(List<PosBankCard> inCards, List<PosBankCard> outCards, String poundageRate, String poundage, String arrival, Map<String,String> logos, GetMoneyVo getMoneyVo){
