...
public interface EmployeeService {
     ...
     * @param deleted   是否返回被删除的账号
     */
    List<EmployeeDto> findByName(String name, Long companyId, int maxSize, boolean disable, boolean deleted);
     ...
     * @param deleted     是否返回被删除的账号
     */
    List<EmployeeDto> findByCompaniesId(List<Long> companiesId, int maxSize, boolean disable, boolean deleted);
     ...
     * @return
     */
    List<EmployeeInfoDto> findByUserDetailType(Byte userType, Long companyId, boolean quitJob, boolean disable,
                                               boolean deleted);
}
