...
import com.pos.pos.dto.WechatAccessTokenDto;
import com.pos.pos.exception.PosUserErrorCode;
import com.pos.pos.dto.support.PosWeChatMediaDto;
...
public class PosWeChatMediaSupport {
    ...
    public ApiResult<String> getWeChatMedia(String mediaId) {
        ...
        if (!media.isSuuc()) {
            logger.error("获取微信素材失败！errcode={}，errmsg={}", media.getErrcode(), media.getErrmsg());
