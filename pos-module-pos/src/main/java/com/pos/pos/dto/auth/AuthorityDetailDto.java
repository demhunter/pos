 ...
 */
public class AuthorityDetailDto extends AuthorityDto implements Serializable {
    ...
    public PosCardDto buildUserInCard() {
        ...
        inCard.setBankName(getBankCardName());
        inCard.setIdCardNo(getBankCardIdCardNO());
        inCard.setBankCardNo(getBankCardNO());
        ...
        inCard.setLastUseTime(getLastUseDate());
        return inCard;
    }
